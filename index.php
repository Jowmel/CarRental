...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    if ($_POST["username"] === "phiwheel" && $_POST["password"] === "PHIWHEELadmin123") {
...
<div class="wrapper"> 
	...
	<div class="info-text login">
				...
				<img src="static/phiwheelLogo-removebg-preview.png" style="position: absolute; height: 70%;width:70%;left: 18%;top: 55%;">
	</div>
</div>
<script>
//loader
